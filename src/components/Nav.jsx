			...
			<div className="flex w-full xl:container xl:m-auto">
				...
				<div className="flex items-center px-2">
					...
					<div className="dropdown">
						...
						<input type="text" placeholder="검색" className="fixed left-0 top-4 -z-10 opacity-0 sm:opacity-100 sm:static sm:flex w-full input input-ghost focus:outline-0 rounded-none sm:rounded bg-gray-300 dark:bg-gray-600 !text-gray-800 dark:!text-white sm:transform-none transition-all js-searchInput" defaultValue="" />
